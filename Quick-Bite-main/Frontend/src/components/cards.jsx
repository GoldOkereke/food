            ...
            <div className="flex flex-col justify-between flex-1 p-5">
                <div>
                    ...
                    <div className="flex justify-between items-center mb-2">
                        ...
                        <div className="flex-shrink-0 flex items-center bg-brown-100 text-brown-800 text-sm px-2.5 py-1 rounded-full ml-2">
                    ...
                    <div className="flex gap-2 mb-4">
                        <span className="bg-brown-50 text-brown-700 text-xs font-medium px-3 py-1.5 rounded-full border border-brown-200">
                            {dataIndex.cuisine}
                        </span>
                    ...
                    <div className="grid grid-cols-3 gap-2 mb-4">
                        <div className="flex flex-col items-center text-center">
                            <div className="flex items-center justify-center w-8 h-8 bg-gradient-to-br from-brown-100 to-pink-100 rounded-full mb-1">
                                <ClockIcon className="w-4 h-4 text-brown-600" />
                            </div>
                        ...
                        <div className="flex flex-col items-center text-center">
                            <div className="flex items-center justify-center w-8 h-8 bg-gradient-to-br from-brown-100 to-pink-100 rounded-full mb-1">
                                <FireIcon className="w-4 h-4 text-brown-600" />
                            </div>
                        ...
                        <div className="flex gap-2 flex-wrap">
                            {dataIndex.tags.slice(0, 3).map((item, i) => (
                                <motion.div
                                    ...
                                    className="bg-gradient-to-r from-brown-50 to-pink-50 text-brown-700 text-xs font-medium px-3 py-1 rounded-full border border-brown-200"
                                >
                                    {item}
                                </motion.div>
                            ))}
