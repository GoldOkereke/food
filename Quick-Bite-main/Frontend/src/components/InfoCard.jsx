...
const InfoCard = () => {
      ...
      <div className="flex justify-center items-center h-screen bg-gray-50">
        ...
        >
          <motion.div
            ...
            className="w-20 h-20 rounded-full border-4 border-brown-500 border-t-transparent"
          />
          <motion.p
            initial={{ y: 20 }}
            animate={{ y: 0 }}
  ...
  if (!foodItem) {
    return (
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-brown-50 via-pink-50 to-purple-50 p-6 text-center"
      >
        <motion.div
          initial={{ scale: 0.8 }}
          animate={{ scale: 1 }}
          className="max-w-md"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-24 mx-auto text-brown-500 mb-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <motion.div
      ...
      className="min-h-screen bg-gradient-to-br from-brown-50 via-pink-50 to-purple-50"
    >
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                ...
                <motion.p
                  ...
                  className="text-brown-300 font-medium text-lg"
                >
                  {foodItem.cuisine}
                </motion.p>
              </div>
            ...
            <div className="lg:w-1/2 p-8">
              ...
              >
                <motion.div
                  whileHover={{ y: -2 }}
                  className="flex items-center gap-2 bg-brown-100 px-4 py-2 rounded-full"
                >
              ...
              <motion.div
                ...
                className="mb-8"
              >
                <div className="text-4xl font-bold bg-gradient-to-r from-brown-600 to-pink-600 bg-clip-text text-transparent inline-flex items-baseline">
                  ${generateRandomPrice()}
              ...
              >
                <h2 className="text-xl font-bold text-gray-800 mb-4 flex items-center gap-3">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-brown-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <motion.button
                              ...
                              className={`px-4 py-2 rounded-lg text-sm transition-all duration-200 font-medium
                                ${selectedOptions[category] === option
                                  ? 'bg-gradient-to-r from-brown-500 to-pink-500 text-white shadow-md'
                                  : 'bg-white text-gray-700 border border-gray-200 hover:bg-brown-50 hover:border-brown-200'}
                              `}
                            >
                              {option}
                            </motion.button>
