...
//                 <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-brown-400 to-pink-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float1"></div>
...
//                 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-br from-purple-400 to-brown-500 rounded-full mix-blend-multiply filter blur-3xl opacity-15 animate-float3"></div>
//             </div>
...
//                         <div className="absolute inset-0 bg-gradient-to-br from-brown-500/0 to-pink-500/0 group-hover:from-brown-500/30 group-hover:to-pink-500/30 transition-all duration-300"></div>

//                         {/* Border gradient */}
//                         <div className="absolute inset-0 border-2 border-transparent group-hover:border-gradient-to-r group-hover:from-brown-500 group-hover:to-pink-500 rounded-xl transition-all duration-300"></div>
//                     </div>
//                 ))}
//             </div>
...
//                                 <div className="w-3/4 h-3/4 bg-gradient-to-r from-brown-500 to-pink-500 rounded-full blur-3xl opacity-20"></div>
//                             </div>
...
//                                 whileTap={{ scale: 0.9 }}
//                                 className="absolute top-6 right-6 text-white bg-gradient-to-r from-brown-500 to-pink-500 rounded-full w-14 h-14 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200"
