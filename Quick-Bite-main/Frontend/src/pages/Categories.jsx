...
const Categories = ({ Item, setItem }) => {
    ...
    const category = [
        { name: "Breakfast", icon: <FaCoffee />, gradient: "from-amber-400 to-brown-500" },
        { name: "Lunch", icon: <FaUtensils />, gradient: "from-brown-400 to-pink-500" },
        ...
        { name: "Appetizer", icon: <FaPizzaSlice />, gradient: "from-red-400 to-brown-500" },
        { name: "Side Dish", icon: <FaLeaf />, gradient: "from-lime-400 to-green-500" },
        { name: "Main Course", icon: <FaHamburger />, gradient: "from-yellow-400 to-brown-500" },
    ];
            ...
            <AnimatePresence>
                {visible && (
                    <div className="fixed bottom-6 left-0 right-0 flex justify-center z-40 px-4">
                        ...
                        >
                            {/* Glow effect */}
                            <div className="absolute inset-0 bg-gradient-to-r from-brown-500 to-pink-500 rounded-full blur-xl opacity-30 -z-10"></div>
                            ...
                            <div className="bg-white/95 backdrop-blur-md border-2 border-white shadow-2xl w-[90vw] max-w-6xl rounded-full overflow-hidden">
                                {/* Gradient top border */}
                                <div className="h-1 bg-gradient-to-r from-brown-500 via-pink-500 to-purple-500"></div>
                                ...
                                <div className="h-1 bg-gradient-to-r from-purple-500 via-pink-500 to-brown-500"></div>
                            </div>
                        </motion.div>
                    </div>
                )}
