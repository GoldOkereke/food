                ...
                {!loading && filteredOrders.length === 0 && (
                    ...
                    >
                        ...
                        <button
                            ...
                            className="px-6 py-3 bg-gradient-to-r from-brown-500 to-pink-500 text-white rounded-full font-semibold hover:shadow-lg transition-all"
                        >
                            Start Shopping
                        </button>
                    </motion.div>
                            ...
                            >
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="pt-4 border-t border-gray-100 flex items-center justify-between">
                                        ...
                                        <span className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-brown-600 to-pink-600">
