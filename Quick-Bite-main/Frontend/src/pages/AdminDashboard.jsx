            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                >
                    <div className="flex items-center gap-3 mb-2">
                        <div className="p-3 bg-gradient-to-r from-brown-500 to-pink-500 rounded-xl">
                    ...
                    {['all', 'pending', 'confirmed', 'preparing', 'ready', 'delivered'].map((status) => (
                        <button
                            ...
                            className={`px-6 py-2.5 rounded-full font-medium transition-all
                                ${filter === status
                                    ? 'bg-gradient-to-r from-brown-500 to-pink-500 text-white shadow-lg shadow-brown-200'
                ...
                <div className="space-y-6">
                    <AnimatePresence>
                        {filteredOrders.map((order, index) => (
                            ...
                            >
                                {/* Order Header */}
                                <div className="p-6 bg-gradient-to-r from-brown-500/10 to-pink-500/10 border-b border-gray-100">
                                    ...
                                    <div className="pt-6 border-t border-gray-200">
                                        <div className="flex flex-wrap items-center justify-between gap-4">
                                            <div>
                                                ...
                                                <p className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-brown-600 to-pink-600">
                                                    ...
                                                    <button
                                                        ...
                                                        className={`px-4 py-2 rounded-lg font-medium text-sm transition-all flex items-center gap-2
                                                            ${order.status?.toLowerCase() === status
                                                                ...
                                                                : 'bg-gradient-to-r from-brown-500 to-pink-500 text-white hover:shadow-lg hover:scale-105'
                                                            }
