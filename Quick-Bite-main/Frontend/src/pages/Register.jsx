            ...
            >
                ...
                <div className="text-center mb-8">
                    <motion.div
                        ...
                        className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-brown-500 to-pink-500 rounded-full mb-4"
                    >
                    ...
                    <p className="text-gray-600">Start ordering!</p>
                </div>
                ...
                >
                    ...
                    <Link
                        to="/signin"
                        className="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-brown-600 to-pink-600 hover:from-brown-700 hover:to-pink-700 transition-all"
                    >
                        Sign in
                    </Link>
                </motion.p>
