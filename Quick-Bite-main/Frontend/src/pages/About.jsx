            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                >
                    {stats.map((stat, index) => (
                        ...
                        >
                            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-r from-brown-500 to-pink-500 text-white mb-4">
                                {stat.icon}
                            </div>
                ...
                >
                    ...
                    <div className="space-y-4 text-gray-700 text-lg leading-relaxed">
                        <p>
                             born from a simple idea: everyone deserves access to great food,
                ...
                <motion.div
                    ...
                    className="bg-gradient-to-r from-brown-500 via-pink-500 to-purple-500 rounded-3xl p-8 md:p-12 text-white text-center shadow-2xl"
                >
                    ...
                    <p className="text-xl mb-8 max-w-2xl mx-auto leading-relaxed">
                        ...
                        there's a place for you in the family. Let's make food
