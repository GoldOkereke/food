...
export const COLORS = {
  // Primary Brand Colors - Brown theme (replaces orange)
  primary: {
    50: '#f6efe9',
    100: '#eedfd0',
    200: '#e0bfa8',
    300: '#c79a81',
    400: '#9e5f4a',
    500: '#7c3a2e',  // Main primary color (brown-500)
    600: '#6b3226',
    700: '#51261c',
    800: '#3e1d15',
    900: '#2c140f',
...
export const GRADIENTS = {
  primary: 'bg-gradient-to-r from-brown-500 to-pink-500',
  primaryHover: 'bg-gradient-to-r from-brown-600 to-pink-600',
  secondary: 'bg-gradient-to-r from-purple-500 to-fuchsia-500',
  background: 'bg-gradient-to-br from-brown-50 via-pink-50 to-purple-50',
  card: 'bg-gradient-to-br from-white to-brown-50',
  text: 'bg-gradient-to-r from-brown-600 to-pink-600 bg-clip-text text-transparent',
};
...
export const SHADOWS = {
  ...
  glow: '0 0 20px rgba(124, 58, 46, 0.3)',
};
...
export const BUTTON_STYLES = {
  primary: `
    bg-gradient-to-r from-brown-500 to-pink-500
    hover:from-brown-600 hover:to-pink-600
  ...
  outline: `
    ...
    hover:border-brown-500 hover:text-brown-600
