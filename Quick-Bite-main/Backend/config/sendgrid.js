...
const sendWelcomeEmail = async (userEmail, userName) => {
    ...
    <head>
        <style>
            ...
            .header { background: linear-gradient(135deg, #7c3a2e 0%, #ec4899 100%); color: white; padding: 30px; text-align: center; border-radius: 10px 10px 0 0; }
            .content { background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px; }
            .button { display: inline-block; background: linear-gradient(135deg, #7c3a2e 0%, #ec4899 100%); color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; margin: 20px 0; }
